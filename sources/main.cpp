...
#include "/home/bburguie/Documents/humangl/includes/BVHAnimation.hpp"
#include <iostream>

int main(int argc, char **argv)
{
	BVHAnimation animation("/home/bburguie/Documents/humangl/animations/bvh/climb.bvh", "Climb");
	try
	{
		animation.Parse();
	}
